...
CSV_FILE = os.path.join(os.getcwd(), 'app/data_clean/final_merge_clean.csv')
CONTACT = os.path.join(os.getcwd(), 'app/data_clean/zz_account_contact_persoon_finance.csv')
